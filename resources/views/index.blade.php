                ...
                <div class="card  mb-3 border-0 mb-5 shadow-1" style="border-left: 1px solid rgba(0, 0, 0, 0.05) !important">
                    <div class="card-header custom-card-header border-0 rounded-0">
                        <div class="d-flex flex-row">
                            <div class="p-1">
                                @if ($postDetail->user->isVerified == 0)
                                    <img src="{{ asset($postDetail->user->img_path) }}" class="home_user_profile " alt=""
                                        id="">
                                @elseif($$postDetail->user->isVerified == 1)
                                    <img src="{{ asset($postDetail->user->avatar) }}" class="home_user_profile" alt=""
                                        id="">
                                @elseif($$postDetail->user->isVerified == 2)
                                    <img src="{{ asset($postDetail->user->avatar) }}" class="home_user_profile" alt=""
                                        id="">
                                @endif
                            </div>
